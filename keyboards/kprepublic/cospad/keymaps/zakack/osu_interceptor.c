...
alpha_up    = {.type = EV_KEY , .code = KEY_F13      , .value = 0},
beta_up   = {.type = EV_KEY , .code = KEY_F14      , .value = 0},
alpha_down  = {.type = EV_KEY , .code = KEY_F13      , .value = 1},
beta_down = {.type = EV_KEY , .code = KEY_F14      , .value = 1};
// clang-format on
...
int main(int argc, char *argv[]) {
    ...
    enum { START, KEY_HELD, CAPSLOCK_IS_CTRL } state = START;
